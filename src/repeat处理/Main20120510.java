 ...
 * 
 * (只需要看reads本身的match情况，不需要将其放到ref上去分析)
 * 
 * 因此进一步过滤
 * 并且过滤reads Match包含的情况
 * @author wuxuehong
 * 2012-5-10
 */
public class Main20120510 {
	...
	public Main20120510(){
		String base = "K:/bwa/z=50/01/z=50alusimpleFilter_line01/L1HS_filter/dupsfilter/LAPX_filter/L1PA3L1M4c_filter/CNV_filter/ABfilter/L1ML1P_Filter/";
		readsFilter(base+"Chr22_w+_L1ML1P_filter.txt", base+"ABfilter/Chr22_w+_AB_filter.txt");
	}
