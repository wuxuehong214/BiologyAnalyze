...
/**
 * 删除lowlow_complexity类型的reads
 * @author wuxuehong
 * 2012-5-12
 */
public class Main20120512 {
	...
	public void readRepeatPos(String filename){
		try{
			...
			while(str != null){
				...
				classr = s.next();
				family = s.next();
				if(classr.equals("Low_complexity")){
	...
	public Main20120512(){
		String path = "K:/bwa/z=50/01/z=50alusimpleFilter_line01/L1HS_filter/dupsfilter/LAPX_filter/L1PA3L1M4c_filter/CNV_filter/ABfilter/L1ML1P_Filter/ABfilter/";
		readRepeatPos("K:/bwa/chr22-repeats.txt");
		filterReads(path+"Chr22_w+_AB_filter.txt", path+"lowcomplex_filter/Chr22_w+_lowComplexty_filter.txt");
	}
