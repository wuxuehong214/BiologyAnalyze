...
//			System.out.println(str);
	...
	public Main(){
		...
		for(int i=22;i>=1;i--){
			outFile = "E:/研究生工作/personal data/repeat chr1-22/hg19_Chr"+i+".txt";
//			new Thread(new LoadThread(urlStr,outFile,locat[i-1])).start();
			read( outFile, locat[i-1],i+"");
			}
//		urlStr = "http://genome.ucsc.edu/cgi-bin/hgc?hgsid=230365969&g=htcGetDna2&table=&i=mixed&o=0&l=0&r=155270560&getDnaPos=chrX%3A1-"+locat[22]+"&db=hg19&hgSeq.cdsExon=1&hgSeq.padding5=0&hgSeq.padding3=0&hgSeq.casing=upper&hgSeq.maskRepeats=on&boolshad.hgSeq.maskRepeats=0&hgSeq.repMasking=lower&boolshad.hgSeq.revComp=0&submit=get+DNA";
		outFile = "E:/研究生工作/personal data/repeat chr1-22/hg19_ChrX.txt";
		read(outFile, locat[22],"X");  //x 
		
//		urlStr = "http://genome.ucsc.edu/cgi-bin/hgc?hgsid=230365969&g=htcGetDna2&table=&i=mixed&o=0&l=0&r=155270560&getDnaPos=chrY%3A1-"+locat[23]+"&db=hg19&hgSeq.cdsExon=1&hgSeq.padding5=0&hgSeq.padding3=0&hgSeq.casing=upper&hgSeq.maskRepeats=on&boolshad.hgSeq.maskRepeats=0&hgSeq.repMasking=lower&boolshad.hgSeq.revComp=0&submit=get+DNA";
		outFile = "E:/研究生工作/personal data/repeat chr1-22/hg19_ChrY.txt";
		read(outFile, locat[23],"Y");  //y
	}
	...
	public void read(String outFile, long length,String index){
		int hang = 200000;
		int each = 50;
		String urlStr;
		try {
			...
			long tempEnd;
			while(start <= length){
				tempEnd =  start+each*hang-1;  //结束的位置
	...
	class LoadThread implements Runnable{
		...
		int hang = 200000;
		int each = 50;
		LoadThread(String urlStr,String outFile,long length){
			this.urlStr = urlStr;
